// File: /frontend/src/features/crm/api/customersAPI.js
 ...
 * para la entidad 'Customer'. Se encarga de la comunicación con el backend y de aplicar
 * la capa anticorrupción, transformando las respuestas de la API a un modelo de
 * datos consistente para el frontend.
 */
 ...
 * @returns {Promise<object>} Un objeto con `total_count` y una lista de `items` (clientes) transformados.
 */
 ...
 * @returns {Promise<object>} Los datos del cliente transformados.
 */
 ...
 * @returns {Promise<object>} El cliente recién creado, transformado.
 */
 ...
 * @returns {Promise<object>} El cliente actualizado, transformado.
 */
