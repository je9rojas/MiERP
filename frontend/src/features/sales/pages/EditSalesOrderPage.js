...
import { generateSalesOrderPDFAPI } from '../../reports/api/reportsAPI';
 ...
 */
// (CORREGIDO) Se añade 'isConfirming' a la lista de props recibidas.
const OrderActions = ({ status, isSubmitting, isConfirming, isPrinting, onConfirm, onNavigateToShipment, onPrint }) => {
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', my: 2, gap: 2 }}>
            ...
            {status === 'draft' && (
                <Button
                    ...
                    disabled={isSubmitting || isPrinting}
                >
                    {/* La variable 'isConfirming' ahora está definida y se puede usar. */}
        ...
        <Container maxWidth="xl" sx={{ my: 4 }}>
            <Paper sx={{ p: { xs: 2, md: 4 }, borderRadius: 2 }}>
                ...
                <OrderActions
                    ...
                    isConfirming={isConfirming} // (CORREGIDO) Se pasa la prop 'isConfirming'.
