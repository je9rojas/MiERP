        ...
        <Grid container spacing={3}>
            <Grid item xs={12} md={8}>
                <Autocomplete
                    ...
                    // Se asegura de que el valor sea `null` si no existe o si las opciones aún no están listas.
                    // Esto previene que Autocomplete intente buscar un valor en una lista vacía durante la carga inicial.
