...
import { Container, Paper, Box, CircularProgress, Typography, Alert, Button } from '@mui/material';
...
const PurchaseBillDetailsPage = () => {
    ...
    const {
        ...
        enabled: !!billId, // La query solo se ejecuta si hay un billId
    });
        ...
        <Container maxWidth="lg" sx={{ my: 4 }}>
            <Paper sx={{ p: { xs: 2, md: 4 }, borderRadius: 2 }}>
                <PageHeader
                    ...
                    subtitle={`Información detallada de la recepción asociada a la OC #${bill?.purchase_order_number || ''}`}
                    showAddButton={false}
                />
