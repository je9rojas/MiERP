  ...
  return (
    <Formik
      initialValues={{
        ...
        product_type: initialData.product_type || 'n_a',
        shape: initialData.shape || 'n_a',
      ...
      onSubmit={(values) => {
        const cleanedDimensions = Object.fromEntries(
            Object.entries(values.dimensions).filter(([, value]) => value !== null && value !== '')
        );
...
// ==============================================================================
// SECCIÓN 4: EXPORTACIÓN DEL COMPONENTE
// ==============================================================================
