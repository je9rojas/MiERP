...
// - En producción (Render/Vercel), 'process.env.REACT_APP_API_URL' será la URL de tu backend en vivo.
// - En desarrollo local, leerá el valor de tu archivo /frontend/.env.
// - Si ninguna está definida, usa localhost como un fallback seguro.
