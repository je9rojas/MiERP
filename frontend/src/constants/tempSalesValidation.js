...
export const salesOrderFormValidationSchema = yup.object().shape({
    // --- CORRECCIÓN CRÍTICA ---
    // El campo en el formulario se llama `customer`, no `customer_id`.
    // La validación debe apuntar al nombre de campo correcto.
    customer: yup.object()
        .nullable()
    ...
    notes: yup.string().nullable(), // Permitir que las notas sean opcionales
