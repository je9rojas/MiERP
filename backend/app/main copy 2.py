...
- Organizar y registrar todos los endpoints de la API de manera modular y escalable
  bajo un prefijo de API unificado (ej. /api/v1).
"""
...
# La documentación de la API (Swagger y ReDoc) se deshabilita en entornos productivos.
app = FastAPI(
...
# Nótese que aquí ya no se añade el prefijo "/api" en cada línea.
