...
class Settings(BaseSettings):
    ...
    Pydantic las validará automáticamente al iniciar la aplicación. Si una variable
    existe en el archivo .env, debe tener un campo correspondiente aquí.
    """
    ...
    # Se definen los campos para que coincidan con el archivo .env y se evita el error 'Extra inputs'.
...
# Se crea una única instancia global de la configuración.
settings = Settings()