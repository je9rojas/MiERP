...
async def add_stock_from_goods_receipt(
    ...
    for item in receipt.items:
        ...
        # Se pasa el ID del producto como un string hexadecimal válido.
...
async def update_product_summary_from_lots(
    ...
    # --- CORRECCIÓN CRÍTICA ---
    # Se valida si el string del ID es un ObjectId válido antes de usarlo para
    # evitar la salida silenciosa y registrar un error claro si falla.
    ...
    await product_repo.update_one_by_id(product_id_str, update_data, session=session)
