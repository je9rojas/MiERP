...
class SalesOrderPDFService:
    ...
    def __init__(self, order_data: Dict[str, Any], document_title: str, company_info: Dict[str, Any]):
        ...
        # --- MODIFICACIÓN PARA VISUALIZACIÓN EN DÓLARES ---
        # Se cambia el símbolo y el código de la moneda para la demostración.
        self.currency_symbol = "US$"
        self.currency_code = "USD"
        self.currency_name = "Dólares Americanos"
    ...
    def _draw_order_info(self):
        ...
        # (MODIFICADO) Se utiliza la variable de clase para mostrar la moneda en Dólares.
        currency_text = f"Moneda: {self.currency_code} ({self.currency_name})"
    ...
    def _draw_items_table(self):
        ...
        # (MODIFICADO) Se utiliza la variable de clase para mostrar el símbolo de Dólares.
